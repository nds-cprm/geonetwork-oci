...
<xsl:stylesheet xmlns:java="java:org.fao.geonet.util.XslUtil" xmlns:math="http://exslt.org/math"
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:EX_BoundingPolygon" priority="20">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>

    <xsl:apply-templates mode="iso19139.mgbsumarizado" select="gmd:extentTypeCode">
    ...
    <xsl:apply-templates mode="iso19139.mgbsumarizado" select="gmd:polygon">
      <xsl:with-param name="schema" select="$schema"/>
      <xsl:with-param name="edit" select="$edit"/>
    </xsl:apply-templates>
  </xsl:template>
  ...
  XML in DataManager.
  -->
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:polygon" priority="20">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template name="iso19139.mgbsumarizado-global-bbox">
  ...
  <!-- ============================================================================= -->
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:EX_GeographicBoundingBox" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
