...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gmd="http://www.isotc211.org/2005/gmd"
  ...
  <xsl:template mode="schema-hidden-fields"
    ...
    <xsl:variable name="capabilitiesUrl">
      <xsl:call-template name="iso19139.mgbsumarizado-getServiceURL">
  ...
  <!-- main template - the way into processing iso19139.mgbsumarizado -->
  <xsl:template name="metadata-iso19139.mgbsumarizado">
    <xsl:param name="schema"/>
    <xsl:param name="edit" select="false()"/>
    <xsl:param name="embedded"/>

    <xsl:apply-templates mode="iso19139.mgbsumarizado" select=".">
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="*|@*">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:variable name="empty">
          <xsl:apply-templates mode="iso19139.mgbsumarizadoIsEmpty" select="."/>
        </xsl:variable>
  ...
  <xsl:template mode="iso19139.mgbsumarizado"
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:identificationInfo|gmd:distributionInfo|
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:*[gco:Date|gco:DateTime|gco:Integer|gco:Decimal|gco:Boolean|gco:Real|gco:Measure|gco:Length|gco:Distance|gco:Angle|gco:Scale|gco:RecordType|gmx:MimeFileType]|
    ...
    <xsl:call-template name="iso19139.mgbsumarizadoString">
      <xsl:with-param name="schema" select="$schema"/>
      <xsl:with-param name="edit" select="$edit"/>
    </xsl:call-template>
  </xsl:template>
  ...
  -->
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:distance" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
      ...
      <xsl:when test="$edit=true()">
        <xsl:variable name="text">
          ...
          <div>
            ...
            &#160;
            <xsl:value-of select="/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name = 'uom']/label"/>
            &#160;
 ...
 Display a list of related resources to which the current service metadata operatesOn.
   ...
   template in metadata-iso19139.mgbsumarizado-utils.xsl).
    -->
  <xsl:template mode="iso19139.mgbsumarizado" match="srv:coupledResource/srv:SV_CoupledResource/srv:identifier"
                priority="200">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  -->
  <xsl:template mode="iso19139.mgbsumarizado" match="gts:TM_PeriodDuration|gml:duration" priority="100">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template name="iso19139.mgbsumarizado-translatedString">
    <xsl:param name="schema"/>
  ...
  <xsl:template name="iso19139.mgbsumarizadoString">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    <xsl:variable name="text">
      <xsl:choose>
        <xsl:when test="not($edit=true() and $widget)">
          ...
          <xsl:call-template name="iso19139.mgbsumarizado-translatedString">
            <xsl:with-param name="schema" select="$schema"/>
            <xsl:with-param name="edit" select="$edit"/>
            <xsl:with-param name="langId" select="$langId"/>
            <xsl:with-param name="validator" select="$validator"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gco:ScopedName|gco:LocalName">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <!-- GML time interval -->
  <xsl:template mode="iso19139.mgbsumarizado" match="gml:timeInterval">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
      ...
      <xsl:when test="$edit">
        <xsl:apply-templates mode="simpleElement" select=".">
          ...
          <xsl:with-param name="title"
                          select="/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gml:timeInterval']/label"/>
        </xsl:apply-templates>
      </xsl:when>
      <xsl:otherwise>
        <xsl:variable name="text">
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gml:identifier|gml:axisDirection|gml:descriptionReference">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <!-- gmx:FileName could be used as substitution of any
    ...
    suggestion.
    -->
  <xsl:template mode="iso19139.mgbsumarizado" name="iso19139.mgbsumarizado-file-upload" match="*[gmx:FileName]">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>

    <xsl:variable name="src" select="gmx:FileName/@src"/>

    <xsl:call-template name="iso19139.mgbsumarizado-file-or-logo-upload">
      <xsl:with-param name="schema" select="$schema"/>
      <xsl:with-param name="edit" select="$edit"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:contactInstructions[gmx:FileName]" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template name="iso19139.mgbsumarizado-file-or-logo-upload">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="ref"/>
        ...
        <xsl:choose>
          <xsl:when test="$edit">
            ...
            <xsl:if test="$delButton">
              <xsl:apply-templates mode="iso19139.mgbsumarizadoFileRemove" select="gmx:FileName">
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:*[*/@codeList]|srv:*[*/@codeList]">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    <xsl:choose>
      <xsl:when test="$multiple=true()">
        ...
        <xsl:if test="$firstElement">
          <xsl:call-template name="iso19139.mgbsumarizadoCodelistMultiple">
            <xsl:with-param name="schema" select="$schema"/>
            <xsl:with-param name="edit" select="$edit"/>
          </xsl:call-template>
        </xsl:if>
      ...
      <xsl:otherwise>
        <xsl:call-template name="iso19139.mgbsumarizadoCodelist">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
        </xsl:call-template>
      </xsl:otherwise>
  ...
  <xsl:template name="iso19139.mgbsumarizadoCodelist">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:apply-templates mode="simpleElement" select=".">
      <xsl:with-param name="schema" select="$schema"/>
      <xsl:with-param name="edit" select="$edit"/>
      <xsl:with-param name="text">
        <xsl:apply-templates mode="iso19139.mgbsumarizadoGetAttributeText" select="*/@codeListValue">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
        </xsl:apply-templates>
      </xsl:with-param>
  ...
  -->
  <xsl:template name="iso19139.mgbsumarizadoCodelistMultiple">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  -->
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:LanguageCode" priority="22">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>

    <xsl:call-template name="iso19139.mgbsumarizadoGetIsoLanguage">
  ...
  and iso code.-->
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:PT_Locale/@id"
                priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  -->
    <xsl:variable name="codelistProfil">
      <xsl:choose>
        <xsl:when test="starts-with($schema,'iso19139.mgbsumarizado.')">
          <xsl:copy-of
    ...
    <xsl:variable name="codelistCore">
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:copy-of
            select="$labels/schemas/*[name(.)='iso19139.mgbsumarizado']/codelists/codelist[@name = $qname and not(@displayIf)]"/>
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
  ...
  <xsl:template mode="iso19139.mgbsumarizadoGetAttributeText" match="@*">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:dateStamp|gmd:fileIdentifier" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:electronicMailAddress" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  -->
  <xsl:template match="gmd:MD_Keywords" mode="iso19139.mgbsumarizado-snippet-editor">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    * transformation: current transformation
    ...
    <xsl:variable name="transformation"
                  select="if (count(descendant::gmd:keyword/gmx:Anchor) > 0) then 'to-iso19139.mgbsumarizado-keyword-with-anchor'
      else if (../@xlink:href) then 'to-iso19139.mgbsumarizado-keyword-as-xlink'
      else 'to-iso19139.mgbsumarizado-keyword'"/>

    <!-- Define the list of transformation mode available.
    -->
    <xsl:variable name="parentName" select="name(..)"/>

    <xsl:variable name="listOfTransformations">'to-iso19139.mgbsumarizado-keyword',
      'to-iso19139.mgbsumarizado-keyword-with-anchor', 'to-iso19139.mgbsumarizado-keyword-as-xlink'
    </xsl:variable>
    ...
    <xsl:call-template name="iso19139.mgbsumarizado-snippet-editor">
  ...
  <xsl:template name="iso19139.mgbsumarizado-snippet-editor">
  ...
  <!-- descriptiveKeywords -->
  <!-- ============================================================================= -->
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:descriptiveKeywords">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
          ...
          <xsl:with-param name="content">
            ...
            <xsl:choose>
              ...
              <xsl:when test="$isThesaurusAvailable">
                <xsl:apply-templates select="gmd:MD_Keywords" mode="iso19139.mgbsumarizado-snippet-editor">
                  <xsl:with-param name="edit" select="$edit"/>
                  <xsl:with-param name="schema" select="$schema"/>
                </xsl:apply-templates>
              </xsl:when>
        ...
        <xsl:apply-templates mode="simpleElement" select=".">
          ...
          <xsl:with-param name="text">
            <xsl:variable name="value">
                  ...
                  <xsl:otherwise>
                    ...
                    <xsl:call-template name="iso19139.mgbsumarizado-translatedString">
                      ...
                      <xsl:with-param name="langId">
                        <xsl:call-template name="iso19139.mgbsumarizado-getLangId">
              ...
              <xsl:if test="$type">
                (<xsl:value-of
                select="/root/gui/schemas/*[name(.)='iso19139.mgbsumarizado']/codelists/codelist[@name = 'gmd:MD_KeywordTypeCode']/
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:dateTime|gmd:usageDateTime|gmd:plannedAvailableDateTime"
                priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="*[geonet:info/isTemplate='s']" priority="3">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="@gco:isoType"/>

  <!-- ==================================================================== -->
  <!-- Metadata -->
  <!-- ==================================================================== -->

  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:MD_Metadata|*[@gco:isoType='gmd:MD_Metadata']">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="embedded"/>
    ...
    <xsl:choose>
      ...
      <xsl:when test="$currTab='metadata'">
        <xsl:call-template name="iso19139.mgbsumarizadoMetadata">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
        </xsl:call-template>
      </xsl:when>
      ...
      <xsl:when test="$currTab='ISOMinimum'">
        <xsl:call-template name="iso19139.mgbsumarizado-isotabs">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
      ...
      <xsl:when test="$currTab='ISOAll'">
        <xsl:call-template name="iso19139.mgbsumarizadoComplete">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
        </xsl:call-template>
      </xsl:when>
      ...
      <xsl:when test="$currTab='inspire'">
        <xsl:call-template name="iso19139.mgbsumarizado-inspiretabs">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
          <xsl:with-param name="dataset" select="$dataset"/>
        </xsl:call-template>
      ...
      <!-- default -->
      <xsl:otherwise>
        <xsl:call-template name="iso19139.mgbsumarizadoSimple">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
          <xsl:with-param name="flat"
                          select="/root/gui/config/metadata-tab/*[name(.)=$currTab]/@flat"/>
  ...
  <xsl:template name="iso19139.mgbsumarizado-isotabs">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    <xsl:for-each select="gmd:identificationInfo/*">
      <xsl:call-template name="iso19139.mgbsumarizado-complexElementGuiWrapper">
        <xsl:with-param name="title">
          <xsl:choose>
            <xsl:when test="$dataset=true()">
              <xsl:value-of
                select="/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:MD_DataIdentification']/label"/>
            </xsl:when>
            <xsl:when
              test="local-name(.)='SV_ServiceIdentification' or contains(@gco:isoType, 'SV_ServiceIdentification')">
              <xsl:value-of
                select="/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='srv:SV_ServiceIdentification']/label"/>
            </xsl:when>
            <xsl:otherwise>
        ...
        <xsl:with-param name="content">
          ...
          <xsl:if test="$dataset">
            <xsl:for-each select="gmd:extent/gmd:EX_Extent">
              <xsl:call-template name="iso19139.mgbsumarizado-complexElementGuiWrapper">
                <xsl:with-param name="title"
                                select="/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:EX_Extent']/label"/>
                <xsl:with-param name="content">
    ...
    <xsl:if test="$core and $dataset">
      ...
      <xsl:call-template name="iso19139.mgbsumarizado-complexElementGuiWrapper">
        <xsl:with-param name="title"
                        select="/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:LI_Lineage']/label"/>
        <xsl:with-param name="id"
                        select="generate-id(/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:LI_Lineage']/label)"/>
        <xsl:with-param name="content">
      ...
      <xsl:call-template name="iso19139.mgbsumarizado-complexElementGuiWrapper">
        <xsl:with-param name="title"
                        select="/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:referenceSystemInfo']/label"/>
        <xsl:with-param name="id"
                        select="generate-id(/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:referenceSystemInfo']/label)"/>
        <xsl:with-param name="content">
      ...
      <xsl:call-template name="iso19139.mgbsumarizado-complexElementGuiWrapper">
        <xsl:with-param name="title"
                        select="/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:distributionInfo']/label"/>
        <xsl:with-param name="id"
                        select="generate-id(/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:distributionInfo']/label)"/>
        <xsl:with-param name="content">
    ...
    <xsl:call-template name="iso19139.mgbsumarizado-complexElementGuiWrapper">
      <xsl:with-param name="title"
                      select="/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:MD_Metadata']/label"/>
      <xsl:with-param name="id"
                      select="generate-id(/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:MD_Metadata']/label)"/>
      <xsl:with-param name="content">
        ...
        <xsl:for-each select="gmd:contact">
          ...
          <xsl:call-template name="iso19139.mgbsumarizado-complexElementGuiWrapper">
            <xsl:with-param name="title"
                            select="/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:contact']/label"/>
            <xsl:with-param name="content">
  ...
  <xsl:template name="iso19139.mgbsumarizadoComplete">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template name="iso19139.mgbsumarizadoMetadata">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="flat"/>
  ...
  <xsl:template name="iso19139.mgbsumarizadoSimple">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="flat"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="//gmd:language[gco:CharacterString]" priority="20">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template name="iso19139.mgbsumarizadoGetIsoLanguage" mode="iso19139.mgbsumarizadoGetIsoLanguage" match="*">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="value"/>
    <xsl:param name="ref"/>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        ...
        <xsl:if test="../gmd:locale or ../../gmd:locale">
          ...
          select="string(/root/gui/schemas/iso19139.mgbsumarizado/labels/element[@name='gmd:locale' and not(@context)]/label)"/>
          <xsl:text>:</xsl:text>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:transferOptions">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:contact|gmd:pointOfContact|gmd:citedResponsibleParty">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>

    <xsl:call-template name="iso19139.mgbsumarizado-contactTemplate">
      <xsl:with-param name="edit" select="$edit"/>
      <xsl:with-param name="schema" select="$schema"/>
    </xsl:call-template>
  </xsl:template>

  <xsl:template name="iso19139.mgbsumarizado-contactTemplate">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:CI_OnlineResource" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    <xsl:variable name="name">
      <xsl:for-each select="gmd:name">
        <xsl:call-template name="iso19139.mgbsumarizado-localised">
          <xsl:with-param name="langId" select="$langId"/>
        </xsl:call-template>
      </xsl:for-each>
    </xsl:variable>
    ...
    <xsl:choose>
      <xsl:when test="$edit=true()">
        <xsl:apply-templates mode="iso19139.mgbsumarizadoEditOnlineRes" select=".">
          <xsl:with-param name="schema" select="$schema"/>
        </xsl:apply-templates>
      </xsl:when>
  ...
  <xsl:template mode="iso19139.mgbsumarizadoEditOnlineRes" match="*">
    <xsl:param name="schema"/>
    ...
    <xsl:apply-templates mode="complexElement" select=".">
      ...
      <xsl:with-param name="content">
        ...
        <xsl:apply-templates mode="iso19139.mgbsumarizado" select="gmd:protocol">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="true()"/>
        </xsl:apply-templates>
        ...
        <xsl:choose>
          <xsl:when test="matches(gmd:protocol[1]/gco:CharacterString,'^WWW:DOWNLOAD-.*-http--download.*')
            ...
            <xsl:apply-templates mode="iso19139.mgbsumarizadoFileRemove"
          ...
          <xsl:when test="string(gmd:protocol[1]/gco:CharacterString)='DB:POSTGIS'
            and string(gmd:name/gco:CharacterString|gmd:name/gmx:MimeFileType)!=''">
            <xsl:apply-templates mode="iso19139.mgbsumarizadoGeoPublisher" select="gmd:name/gco:CharacterString">
          ...
          <xsl:otherwise>
            ...
            <xsl:apply-templates mode="iso19139.mgbsumarizado" select="gmd:name">
              <xsl:with-param name="schema" select="$schema"/>
              <xsl:with-param name="edit" select="true()"/>
            </xsl:apply-templates>
          </xsl:otherwise>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:CI_OnlineResource[
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:protocol" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:name[name(..)='gmd:CI_OnlineResource']" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbsumarizadoFileRemove" match="*">
        ...
        <table width="100%">
          <tr>
            ...
            <td align="right">
              ...
              <xsl:if test="$geo">
                <xsl:call-template name="iso19139.mgbsumarizadoGeoPublisherButton">
  ...
  <xsl:template mode="iso19139.mgbsumarizadoGeoPublisher" match="*">
    <xsl:param name="access" select="'public'"/>
    <xsl:param name="id"/>
  ...
  <xsl:template name="iso19139.mgbsumarizadoGeoPublisherButton">
    <xsl:param name="access" select="'public'"/>

    <xsl:if test="/root/gui/config/editor-geopublisher">
      <xsl:variable name="bbox">
        <xsl:call-template name="iso19139.mgbsumarizado-global-bbox"/>
      </xsl:variable>
  ...
  <!-- ===================================================================== -->
  <!-- === iso19139.mgbsumarizado brief formatting === -->
  <!-- ===================================================================== -->
  <xsl:template mode="superBrief" match="gmd:MD_Metadata|*[@gco:isoType='gmd:MD_Metadata']"
    ...
    <title>
      <xsl:apply-templates mode="iso19139.mgbsumarizado-localised"
                           select="gmd:identificationInfo/*/gmd:citation/*/gmd:title">
        <xsl:with-param name="langId" select="$langId"/>
      </xsl:apply-templates>
    </title>
    <abstract>
      <xsl:apply-templates mode="iso19139.mgbsumarizado-localised" select="gmd:identificationInfo/*/gmd:abstract">
        <xsl:with-param name="langId" select="$langId"/>
      </xsl:apply-templates>
    </abstract>
  </xsl:template>

  <xsl:template match="iso19139.mgbsumarizadoBrief">
    <metadata>
      <xsl:call-template name="iso19139.mgbsumarizado-brief"/>
    </metadata>
  </xsl:template>

  <xsl:template name="iso19139.mgbsumarizado-brief">
    <xsl:variable name="download_check">
      <xsl:text>&amp;fname=&amp;access</xsl:text>
    </xsl:variable>
  ...
  <xsl:template mode="briefster" match="*">
    ...
    <xsl:if test="gmd:citation/gmd:CI_Citation/gmd:title">
      <title>
        <xsl:apply-templates mode="iso19139.mgbsumarizado-localised" select="gmd:citation/gmd:CI_Citation/gmd:title">
    ...
    <xsl:if test="gmd:abstract">
      <abstract>
        <xsl:apply-templates mode="iso19139.mgbsumarizado-localised" select="gmd:abstract">
          <xsl:with-param name="langId" select="$langId"></xsl:with-param>
        </xsl:apply-templates>
      </abstract>
    </xsl:if>
    ...
    <xsl:for-each select=".//gmd:keyword[not(@gco:nilReason)]">
      <keyword>
        <xsl:apply-templates mode="iso19139.mgbsumarizado-localised" select=".">
          <xsl:with-param name="langId" select="$langId"></xsl:with-param>
        </xsl:apply-templates>
      </keyword>
    </xsl:for-each>
  ...
  <!-- In order to add profil specific tabs
    ...
    <xsl:template name="iso19139.mgbsumarizado.profileIdCompleteTab">
    <xsl:param name="tabLink"/>
    <xsl:param name="schema"/>

    Load iso19139.mgbsumarizado complete tab if needed
    <xsl:call-template name="iso19139.mgbsumarizadoCompleteTab">
  ...
  <!-- ============================================================================= -->
  <!-- iso19139.mgbsumarizado complete tab template  -->
  <!-- ============================================================================= -->

  <xsl:template name="iso19139.mgbsumarizadoCompleteTab">
    <xsl:param name="tabLink"/>
    <xsl:param name="schema"/>
  ...
  -->
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:country[gco:CharacterString]" priority="1">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <!-- Display extra thumbnails (not managed by GeoNetwork).
    ...
    simple elements.
  -->
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:graphicOverview" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  -->
  <xsl:template mode="iso19139.mgbsumarizado" match="gmd:locale|geonet:child[string(@name)='locale']"
                priority="1">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:choose>
  ...
  >
    ...
    <xsl:call-template name="iso19139.mgbsumarizado-localizedCharStringField">
      <xsl:with-param name="schema" select="$schema"/>
      <xsl:with-param name="edit" select="$edit"/>
  ...
  -->
  <xsl:template name="iso19139.mgbsumarizado-localizedCharStringField">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="class" select="''"/>
    ...
    <xsl:variable name="widget">
      <xsl:if test="$edit=true()">
        <xsl:variable name="tmpFreeText">
          <xsl:call-template name="iso19139.mgbsumarizado-PT_FreeText_Tree"/>
        </xsl:variable>
        ...
        <xsl:variable name="mainLangId">
          <xsl:call-template name="iso19139.mgbsumarizado-getLangIdFromMetadata">
  ...
  -->
  <xsl:template name="iso19139.mgbsumarizado-PT_FreeText_Tree">
   <xsl:variable name="mainLang">
      <xsl:call-template name="langId19139">
         <xsl:with-param name="md" select="/root/*"/>
      </xsl:call-template>
    ...
    <xsl:for-each select="$languages">
      ...
      <xsl:variable name="code">
        <xsl:call-template name="iso19139.mgbsumarizado-getLangCode">
          <xsl:with-param name="md"
                          select="ancestor-or-self::*[name(.)='gmd:MD_Metadata' or @gco:isoType='gmd:MD_Metadata']"/>
