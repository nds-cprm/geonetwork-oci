...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <!-- Required for utility-fn.xsl -->
  ...
  <xsl:include href="../../formatter/jsonld/iso19139.mgbsumarizado-to-jsonld.xsl"/>
  ...
  <xsl:variable name="langId" select="gn-fn-iso19139.mgbsumarizado:getLangId($metadata, $language)"/>
