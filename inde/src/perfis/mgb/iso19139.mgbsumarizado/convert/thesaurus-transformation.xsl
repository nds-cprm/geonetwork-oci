...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="to-iso19139.mgbsumarizado-keyword-with-anchor">
    <xsl:call-template name="to-iso19139.mgbsumarizado-keyword">
  ...
  <xsl:template name="to-iso19139.mgbsumarizado-keyword-as-xlink">
    <xsl:call-template name="to-iso19139.mgbsumarizado-keyword">
  ...
  <!-- Convert a concept to an ISO19139 keywords.
    ...
    -->
  <xsl:template name="to-iso19139.mgbsumarizado-keyword">
    ...
    <xsl:apply-templates mode="to-iso19139.mgbsumarizado-keyword" select=".">
  ...
  <xsl:template mode="to-iso19139.mgbsumarizado-keyword" match="*[not(/root/request/skipdescriptivekeywords)]">
    ...
    <gmd:descriptiveKeywords>
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:call-template name="iso19139.mgbsumarizado-to-md-keywords">
            <xsl:with-param name="withAnchor" select="$withAnchor"/>
            <xsl:with-param name="withThesaurusAnchor" select="$withThesaurusAnchor"/>
            <xsl:with-param name="listOfLanguage" select="$listOfLanguage"/>
            <xsl:with-param name="textgroupOnly" select="$textgroupOnly"/>
  ...
  <xsl:template mode="to-iso19139.mgbsumarizado-keyword" match="*[/root/request/skipdescriptivekeywords]">
    <xsl:param name="textgroupOnly"/>
    <xsl:param name="listOfLanguage"/>
    <xsl:param name="withAnchor"/>
    <xsl:param name="withThesaurusAnchor"/>
  ...
  <xsl:template name="iso19139.mgbsumarizado-to-md-keywords">
    <xsl:param name="textgroupOnly"/>
    <xsl:param name="listOfLanguage"/>
    <xsl:param name="withAnchor"/>
    <xsl:param name="withThesaurusAnchor"/>
  ...
  <xsl:function name="geonet:iso19139.mgbsumarizado-add-thesaurus-info">
  ...
  <xsl:template name="to-iso19139.mgbsumarizado-extent">
