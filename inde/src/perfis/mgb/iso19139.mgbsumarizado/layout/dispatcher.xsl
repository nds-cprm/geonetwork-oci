...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--
    Load the schema configuration for the editor.
      -->
  <xsl:template name="get-iso19139.mgbsumarizado-configuration">
    <xsl:copy-of select="document('config-editor.xml')"/>
  </xsl:template>


  <xsl:template name="dispatch-iso19139.mgbsumarizado">
    ...
    <xsl:apply-templates mode="mode-iso19139.mgbsumarizado" select="$base">
