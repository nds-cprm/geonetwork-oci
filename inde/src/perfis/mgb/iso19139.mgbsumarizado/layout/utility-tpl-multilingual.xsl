...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gmd="http://www.isotc211.org/2005/gmd"
  ...
  <!-- Get the main metadata languages -->
   <xsl:template name="get-iso19139.mgbsumarizado-language">
  ...
  <xsl:template name="get-iso19139.mgbsumarizado-other-languages-as-json">
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:variable name="mainLanguage">
            <xsl:call-template name="get-iso19139.mgbsumarizado-language"/>
          </xsl:variable>
  ...
  <xsl:template name="get-iso19139.mgbsumarizado-other-languages">
    <xsl:variable name="isTemplate" select="$metadata/gn:info[position() = last()]/isTemplate"/>
    <xsl:choose>
      <xsl:when test="$isTemplate = 's' or $isTemplate = 't'">
  ...
  <!-- Template used to return a translation if one found, 
    ...
    -->
  <xsl:template name="iso19139.mgbsumarizado-localised" mode="iso19139.mgbsumarizado-localised" match="*[gco:CharacterString or gmx:Anchor or gmd:PT_FreeText]">
