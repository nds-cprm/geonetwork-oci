...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--
    ...
    -->
  <xsl:template name="iso19139.mgbcompleto-inspiretabs">
      ...
      <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
        ...
        <xsl:with-param name="content">
          ...
          <xsl:if test="not($dataset)">
            ...
            <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
              <xsl:with-param name="title"
                              select="/root/gui/iso19139.mgbcompleto/element[@name='srv:operatesOn']/label"/>
              <xsl:with-param name="content">
                <xsl:apply-templates mode="elementEP"
                                     select="
                  srv:operatesOn|
      ...
      <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
        ...
        <xsl:with-param name="content">
          <xsl:variable name="schematitle"
                        select="string(/root/gui/iso19139.mgbcompleto/element[@name='gmd:resourceConstraints']/label)"/>
          <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
