...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gmd="http://www.isotc211.org/2005/gmd"
  ...
  <xsl:template mode="schema-hidden-fields"
    ...
    <xsl:variable name="capabilitiesUrl">
      <xsl:call-template name="iso19139.mgbcompleto-getServiceURL">
  ...
  <!-- main template - the way into processing iso19139.mgbcompleto -->
  <xsl:template name="metadata-iso19139.mgbcompleto">
    <xsl:param name="schema"/>
    <xsl:param name="edit" select="false()"/>
    <xsl:param name="embedded"/>

    <xsl:apply-templates mode="iso19139.mgbcompleto" select=".">
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="*|@*">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:variable name="empty">
          <xsl:apply-templates mode="iso19139.mgbcompletoIsEmpty" select="."/>
        </xsl:variable>
  ...
  <xsl:template mode="iso19139.mgbcompleto"
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:identificationInfo|gmd:distributionInfo|
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:*[gco:Date|gco:DateTime|gco:Integer|gco:Decimal|gco:Boolean|gco:Real|gco:Measure|gco:Length|gco:Distance|gco:Angle|gco:Scale|gco:RecordType|gmx:MimeFileType]|
    ...
    <xsl:call-template name="iso19139.mgbcompletoString">
      <xsl:with-param name="schema" select="$schema"/>
      <xsl:with-param name="edit" select="$edit"/>
    </xsl:call-template>
  </xsl:template>
  ...
  -->
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:distance" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
      ...
      <xsl:when test="$edit=true()">
        <xsl:variable name="text">
          ...
          <div>
            ...
            &#160;
            <xsl:value-of select="/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name = 'uom']/label"/>
            &#160;
 ...
 Display a list of related resources to which the current service metadata operatesOn.
   ...
   template in metadata-iso19139.mgbcompleto-utils.xsl).
    -->
  <xsl:template mode="iso19139.mgbcompleto" match="srv:coupledResource/srv:SV_CoupledResource/srv:identifier"
                priority="200">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  -->
  <xsl:template mode="iso19139.mgbcompleto" match="gts:TM_PeriodDuration|gml:duration" priority="100">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template name="iso19139.mgbcompleto-translatedString">
    <xsl:param name="schema"/>
  ...
  <xsl:template name="iso19139.mgbcompletoString">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    <xsl:variable name="text">
      <xsl:choose>
        <xsl:when test="not($edit=true() and $widget)">
          ...
          <xsl:call-template name="iso19139.mgbcompleto-translatedString">
            <xsl:with-param name="schema" select="$schema"/>
            <xsl:with-param name="edit" select="$edit"/>
            <xsl:with-param name="langId" select="$langId"/>
            <xsl:with-param name="validator" select="$validator"/>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gco:ScopedName|gco:LocalName">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <!-- GML time interval -->
  <xsl:template mode="iso19139.mgbcompleto" match="gml:timeInterval">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
      ...
      <xsl:when test="$edit">
        <xsl:apply-templates mode="simpleElement" select=".">
          ...
          <xsl:with-param name="title"
                          select="/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gml:timeInterval']/label"/>
        </xsl:apply-templates>
      </xsl:when>
      <xsl:otherwise>
        <xsl:variable name="text">
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gml:identifier|gml:axisDirection|gml:descriptionReference">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <!-- gmx:FileName could be used as substitution of any
    ...
    suggestion.
    -->
  <xsl:template mode="iso19139.mgbcompleto" name="iso19139.mgbcompleto-file-upload" match="*[gmx:FileName]">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>

    <xsl:variable name="src" select="gmx:FileName/@src"/>

    <xsl:call-template name="iso19139.mgbcompleto-file-or-logo-upload">
      <xsl:with-param name="schema" select="$schema"/>
      <xsl:with-param name="edit" select="$edit"/>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:contactInstructions[gmx:FileName]" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template name="iso19139.mgbcompleto-file-or-logo-upload">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="ref"/>
        ...
        <xsl:choose>
          <xsl:when test="$edit">
            ...
            <xsl:if test="$delButton">
              <xsl:apply-templates mode="iso19139.mgbcompletoFileRemove" select="gmx:FileName">
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:*[*/@codeList]|srv:*[*/@codeList]">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    <xsl:choose>
      <xsl:when test="$multiple=true()">
        ...
        <xsl:if test="$firstElement">
          <xsl:call-template name="iso19139.mgbcompletoCodelistMultiple">
            <xsl:with-param name="schema" select="$schema"/>
            <xsl:with-param name="edit" select="$edit"/>
          </xsl:call-template>
        </xsl:if>
      ...
      <xsl:otherwise>
        <xsl:call-template name="iso19139.mgbcompletoCodelist">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
        </xsl:call-template>
      </xsl:otherwise>
  ...
  <xsl:template name="iso19139.mgbcompletoCodelist">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:apply-templates mode="simpleElement" select=".">
      <xsl:with-param name="schema" select="$schema"/>
      <xsl:with-param name="edit" select="$edit"/>
      <xsl:with-param name="text">
        <xsl:apply-templates mode="iso19139.mgbcompletoGetAttributeText" select="*/@codeListValue">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
        </xsl:apply-templates>
      </xsl:with-param>
  ...
  -->
  <xsl:template name="iso19139.mgbcompletoCodelistMultiple">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  -->
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:LanguageCode" priority="22">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>

    <xsl:call-template name="iso19139.mgbcompletoGetIsoLanguage">
  ...
  and iso code.-->
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:PT_Locale/@id"
                priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  -->
    <xsl:variable name="codelistProfil">
      <xsl:choose>
        <xsl:when test="starts-with($schema,'iso19139.mgbcompleto.')">
          <xsl:copy-of
    ...
    <xsl:variable name="codelistCore">
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:copy-of
            select="$labels/schemas/*[name(.)='iso19139.mgbcompleto']/codelists/codelist[@name = $qname and not(@displayIf)]"/>
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
  ...
  <xsl:template mode="iso19139.mgbcompletoGetAttributeText" match="@*">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:dateStamp|gmd:fileIdentifier" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:electronicMailAddress" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  -->
  <xsl:template match="gmd:MD_Keywords" mode="iso19139.mgbcompleto-snippet-editor">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    * transformation: current transformation
    ...
    <xsl:variable name="transformation"
                  select="if (count(descendant::gmd:keyword/gmx:Anchor) > 0) then 'to-iso19139.mgbcompleto-keyword-with-anchor'
      else if (../@xlink:href) then 'to-iso19139.mgbcompleto-keyword-as-xlink'
      else 'to-iso19139.mgbcompleto-keyword'"/>

    <!-- Define the list of transformation mode available.
    -->
    <xsl:variable name="parentName" select="name(..)"/>

    <xsl:variable name="listOfTransformations">'to-iso19139.mgbcompleto-keyword',
      'to-iso19139.mgbcompleto-keyword-with-anchor', 'to-iso19139.mgbcompleto-keyword-as-xlink'
    </xsl:variable>
    ...
    <xsl:call-template name="iso19139.mgbcompleto-snippet-editor">
  ...
  <xsl:template name="iso19139.mgbcompleto-snippet-editor">
  ...
  <!-- descriptiveKeywords -->
  <!-- ============================================================================= -->
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:descriptiveKeywords">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
          ...
          <xsl:with-param name="content">
            ...
            <xsl:choose>
              ...
              <xsl:when test="$isThesaurusAvailable">
                <xsl:apply-templates select="gmd:MD_Keywords" mode="iso19139.mgbcompleto-snippet-editor">
                  <xsl:with-param name="edit" select="$edit"/>
                  <xsl:with-param name="schema" select="$schema"/>
                </xsl:apply-templates>
              </xsl:when>
        ...
        <xsl:apply-templates mode="simpleElement" select=".">
          ...
          <xsl:with-param name="text">
            <xsl:variable name="value">
                  ...
                  <xsl:otherwise>
                    ...
                    <xsl:call-template name="iso19139.mgbcompleto-translatedString">
                      ...
                      <xsl:with-param name="langId">
                        <xsl:call-template name="iso19139.mgbcompleto-getLangId">
              ...
              <xsl:if test="$type">
                (<xsl:value-of
                select="/root/gui/schemas/*[name(.)='iso19139.mgbcompleto']/codelists/codelist[@name = 'gmd:MD_KeywordTypeCode']/
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:dateTime|gmd:usageDateTime|gmd:plannedAvailableDateTime"
                priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="*[geonet:info/isTemplate='s']" priority="3">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="@gco:isoType"/>

  <!-- ==================================================================== -->
  <!-- Metadata -->
  <!-- ==================================================================== -->

  <xsl:template mode="iso19139.mgbcompleto" match="gmd:MD_Metadata|*[@gco:isoType='gmd:MD_Metadata']">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="embedded"/>
    ...
    <xsl:choose>
      ...
      <xsl:when test="$currTab='metadata'">
        <xsl:call-template name="iso19139.mgbcompletoMetadata">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
        </xsl:call-template>
      </xsl:when>
      ...
      <xsl:when test="$currTab='ISOMinimum'">
        <xsl:call-template name="iso19139.mgbcompleto-isotabs">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
      ...
      <xsl:when test="$currTab='ISOAll'">
        <xsl:call-template name="iso19139.mgbcompletoComplete">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
        </xsl:call-template>
      </xsl:when>
      ...
      <xsl:when test="$currTab='inspire'">
        <xsl:call-template name="iso19139.mgbcompleto-inspiretabs">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
          <xsl:with-param name="dataset" select="$dataset"/>
        </xsl:call-template>
      ...
      <!-- default -->
      <xsl:otherwise>
        <xsl:call-template name="iso19139.mgbcompletoSimple">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="$edit"/>
          <xsl:with-param name="flat"
                          select="/root/gui/config/metadata-tab/*[name(.)=$currTab]/@flat"/>
  ...
  <xsl:template name="iso19139.mgbcompleto-isotabs">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    <xsl:for-each select="gmd:identificationInfo/*">
      <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
        <xsl:with-param name="title">
          <xsl:choose>
            <xsl:when test="$dataset=true()">
              <xsl:value-of
                select="/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:MD_DataIdentification']/label"/>
            </xsl:when>
            <xsl:when
              test="local-name(.)='SV_ServiceIdentification' or contains(@gco:isoType, 'SV_ServiceIdentification')">
              <xsl:value-of
                select="/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='srv:SV_ServiceIdentification']/label"/>
            </xsl:when>
            <xsl:otherwise>
        ...
        <xsl:with-param name="content">
          ...
          <xsl:if test="$dataset">
            <xsl:for-each select="gmd:extent/gmd:EX_Extent">
              <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
                <xsl:with-param name="title"
                                select="/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:EX_Extent']/label"/>
                <xsl:with-param name="content">
    ...
    <xsl:if test="$core and $dataset">
      ...
      <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
        <xsl:with-param name="title"
                        select="/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:LI_Lineage']/label"/>
        <xsl:with-param name="id"
                        select="generate-id(/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:LI_Lineage']/label)"/>
        <xsl:with-param name="content">
      ...
      <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
        <xsl:with-param name="title"
                        select="/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:referenceSystemInfo']/label"/>
        <xsl:with-param name="id"
                        select="generate-id(/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:referenceSystemInfo']/label)"/>
        <xsl:with-param name="content">
      ...
      <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
        <xsl:with-param name="title"
                        select="/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:distributionInfo']/label"/>
        <xsl:with-param name="id"
                        select="generate-id(/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:distributionInfo']/label)"/>
        <xsl:with-param name="content">
    ...
    <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
      <xsl:with-param name="title"
                      select="/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:MD_Metadata']/label"/>
      <xsl:with-param name="id"
                      select="generate-id(/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:MD_Metadata']/label)"/>
      <xsl:with-param name="content">
        ...
        <xsl:for-each select="gmd:contact">
          ...
          <xsl:call-template name="iso19139.mgbcompleto-complexElementGuiWrapper">
            <xsl:with-param name="title"
                            select="/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:contact']/label"/>
            <xsl:with-param name="content">
  ...
  <xsl:template name="iso19139.mgbcompletoComplete">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template name="iso19139.mgbcompletoMetadata">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="flat"/>
  ...
  <xsl:template name="iso19139.mgbcompletoSimple">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="flat"/>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="//gmd:language[gco:CharacterString]" priority="20">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template name="iso19139.mgbcompletoGetIsoLanguage" mode="iso19139.mgbcompletoGetIsoLanguage" match="*">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="value"/>
    <xsl:param name="ref"/>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        ...
        <xsl:if test="../gmd:locale or ../../gmd:locale">
          ...
          select="string(/root/gui/schemas/iso19139.mgbcompleto/labels/element[@name='gmd:locale' and not(@context)]/label)"/>
          <xsl:text>:</xsl:text>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:transferOptions">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:contact|gmd:pointOfContact|gmd:citedResponsibleParty">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>

    <xsl:call-template name="iso19139.mgbcompleto-contactTemplate">
      <xsl:with-param name="edit" select="$edit"/>
      <xsl:with-param name="schema" select="$schema"/>
    </xsl:call-template>
  </xsl:template>

  <xsl:template name="iso19139.mgbcompleto-contactTemplate">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:CI_OnlineResource" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    ...
    <xsl:variable name="name">
      <xsl:for-each select="gmd:name">
        <xsl:call-template name="iso19139.mgbcompleto-localised">
          <xsl:with-param name="langId" select="$langId"/>
        </xsl:call-template>
      </xsl:for-each>
    </xsl:variable>
    ...
    <xsl:choose>
      <xsl:when test="$edit=true()">
        <xsl:apply-templates mode="iso19139.mgbcompletoEditOnlineRes" select=".">
          <xsl:with-param name="schema" select="$schema"/>
        </xsl:apply-templates>
      </xsl:when>
  ...
  <xsl:template mode="iso19139.mgbcompletoEditOnlineRes" match="*">
    <xsl:param name="schema"/>
    ...
    <xsl:apply-templates mode="complexElement" select=".">
      ...
      <xsl:with-param name="content">
        ...
        <xsl:apply-templates mode="iso19139.mgbcompleto" select="gmd:protocol">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="edit" select="true()"/>
        </xsl:apply-templates>
        ...
        <xsl:choose>
          <xsl:when test="matches(gmd:protocol[1]/gco:CharacterString,'^WWW:DOWNLOAD-.*-http--download.*')
            ...
            <xsl:apply-templates mode="iso19139.mgbcompletoFileRemove"
          ...
          <xsl:when test="string(gmd:protocol[1]/gco:CharacterString)='DB:POSTGIS'
            and string(gmd:name/gco:CharacterString|gmd:name/gmx:MimeFileType)!=''">
            <xsl:apply-templates mode="iso19139.mgbcompletoGeoPublisher" select="gmd:name/gco:CharacterString">
          ...
          <xsl:otherwise>
            ...
            <xsl:apply-templates mode="iso19139.mgbcompleto" select="gmd:name">
              <xsl:with-param name="schema" select="$schema"/>
              <xsl:with-param name="edit" select="true()"/>
            </xsl:apply-templates>
          </xsl:otherwise>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:CI_OnlineResource[
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:protocol" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:name[name(..)='gmd:CI_OnlineResource']" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="iso19139.mgbcompletoFileRemove" match="*">
        ...
        <table width="100%">
          <tr>
            ...
            <td align="right">
              ...
              <xsl:if test="$geo">
                <xsl:call-template name="iso19139.mgbcompletoGeoPublisherButton">
  ...
  <xsl:template mode="iso19139.mgbcompletoGeoPublisher" match="*">
    <xsl:param name="access" select="'public'"/>
    <xsl:param name="id"/>
  ...
  <xsl:template name="iso19139.mgbcompletoGeoPublisherButton">
    <xsl:param name="access" select="'public'"/>

    <xsl:if test="/root/gui/config/editor-geopublisher">
      <xsl:variable name="bbox">
        <xsl:call-template name="iso19139.mgbcompleto-global-bbox"/>
      </xsl:variable>
  ...
  <!-- ===================================================================== -->
  <!-- === iso19139.mgbcompleto brief formatting === -->
  <!-- ===================================================================== -->
  <xsl:template mode="superBrief" match="gmd:MD_Metadata|*[@gco:isoType='gmd:MD_Metadata']"
    ...
    <title>
      <xsl:apply-templates mode="iso19139.mgbcompleto-localised"
                           select="gmd:identificationInfo/*/gmd:citation/*/gmd:title">
        <xsl:with-param name="langId" select="$langId"/>
      </xsl:apply-templates>
    </title>
    <abstract>
      <xsl:apply-templates mode="iso19139.mgbcompleto-localised" select="gmd:identificationInfo/*/gmd:abstract">
        <xsl:with-param name="langId" select="$langId"/>
      </xsl:apply-templates>
    </abstract>
  </xsl:template>

  <xsl:template match="iso19139.mgbcompletoBrief">
    <metadata>
      <xsl:call-template name="iso19139.mgbcompleto-brief"/>
    </metadata>
  </xsl:template>

  <xsl:template name="iso19139.mgbcompleto-brief">
    <xsl:variable name="download_check">
      <xsl:text>&amp;fname=&amp;access</xsl:text>
    </xsl:variable>
  ...
  <xsl:template mode="briefster" match="*">
    ...
    <xsl:if test="gmd:citation/gmd:CI_Citation/gmd:title">
      <title>
        <xsl:apply-templates mode="iso19139.mgbcompleto-localised" select="gmd:citation/gmd:CI_Citation/gmd:title">
    ...
    <xsl:if test="gmd:abstract">
      <abstract>
        <xsl:apply-templates mode="iso19139.mgbcompleto-localised" select="gmd:abstract">
          <xsl:with-param name="langId" select="$langId"></xsl:with-param>
        </xsl:apply-templates>
      </abstract>
    </xsl:if>
    ...
    <xsl:for-each select=".//gmd:keyword[not(@gco:nilReason)]">
      <keyword>
        <xsl:apply-templates mode="iso19139.mgbcompleto-localised" select=".">
          <xsl:with-param name="langId" select="$langId"></xsl:with-param>
        </xsl:apply-templates>
      </keyword>
    </xsl:for-each>
  ...
  <!-- In order to add profil specific tabs
    ...
    <xsl:template name="iso19139.mgbcompleto.profileIdCompleteTab">
    <xsl:param name="tabLink"/>
    <xsl:param name="schema"/>

    Load iso19139.mgbcompleto complete tab if needed
    <xsl:call-template name="iso19139.mgbcompletoCompleteTab">
  ...
  <!-- ============================================================================= -->
  <!-- iso19139.mgbcompleto complete tab template  -->
  <!-- ============================================================================= -->

  <xsl:template name="iso19139.mgbcompletoCompleteTab">
    <xsl:param name="tabLink"/>
    <xsl:param name="schema"/>
  ...
  -->
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:country[gco:CharacterString]" priority="1">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <!-- Display extra thumbnails (not managed by GeoNetwork).
    ...
    simple elements.
  -->
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:graphicOverview" priority="2">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  -->
  <xsl:template mode="iso19139.mgbcompleto" match="gmd:locale|geonet:child[string(@name)='locale']"
                priority="1">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:choose>
  ...
  >
    ...
    <xsl:call-template name="iso19139.mgbcompleto-localizedCharStringField">
      <xsl:with-param name="schema" select="$schema"/>
      <xsl:with-param name="edit" select="$edit"/>
  ...
  -->
  <xsl:template name="iso19139.mgbcompleto-localizedCharStringField">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
    <xsl:param name="class" select="''"/>
    ...
    <xsl:variable name="widget">
      <xsl:if test="$edit=true()">
        <xsl:variable name="tmpFreeText">
          <xsl:call-template name="iso19139.mgbcompleto-PT_FreeText_Tree"/>
        </xsl:variable>
        ...
        <xsl:variable name="mainLangId">
          <xsl:call-template name="iso19139.mgbcompleto-getLangIdFromMetadata">
  ...
  -->
  <xsl:template name="iso19139.mgbcompleto-PT_FreeText_Tree">
   <xsl:variable name="mainLang">
      <xsl:call-template name="langId19139">
         <xsl:with-param name="md" select="/root/*"/>
      </xsl:call-template>
    ...
    <xsl:for-each select="$languages">
      ...
      <xsl:variable name="code">
        <xsl:call-template name="iso19139.mgbcompleto-getLangCode">
          <xsl:with-param name="md"
                          select="ancestor-or-self::*[name(.)='gmd:MD_Metadata' or @gco:isoType='gmd:MD_Metadata']"/>
