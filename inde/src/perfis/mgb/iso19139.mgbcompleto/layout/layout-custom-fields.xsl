...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gmd="http://www.isotc211.org/2005/gmd"
  ...
  <!-- Readonly elements -->
  <xsl:template mode="mode-iso19139.mgbcompleto" priority="2100" match="gmd:fileIdentifier|gmd:dateStamp">
  ...
  <xsl:template mode="mode-iso19139.mgbcompleto" priority="2000" match="*[gco:*/@uom]">
    <xsl:param name="schema" select="$schema" required="no"/>
    <xsl:param name="labels" select="$labels" required="no"/>
    <xsl:param name="overrideLabel" select="''" required="no"/>
  ...
  <xsl:template mode="mode-iso19139.mgbcompleto" match="gmd:EX_GeographicBoundingBox" priority="2000">
    <xsl:param name="schema" select="$schema" required="no"/>
    <xsl:param name="labels" select="$labels" required="no"/>
    <xsl:param name="overrideLabel" select="''" required="no"/>
  ...
  <xsl:template mode="mode-iso19139.mgbcompleto" match="gmd:EX_BoundingPolygon" priority="2000">
    <xsl:param name="schema" select="$schema" required="no"/>
    <xsl:param name="labels" select="$labels" required="no"/>
