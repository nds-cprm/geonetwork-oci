...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
  ...
  <!-- Get lang #id in metadata PT_Locale section,  deprecated: if not return the 2 first letters
        ...
        -->
  <xsl:function name="gn-fn-iso19139.mgbcompleto:getLangId" as="xs:string">
    <xsl:param name="md"/>
    <xsl:param name="lang"/>
  ...
  <xsl:function name="gn-fn-iso19139.mgbcompleto:getCodeListType" as="xs:string">
  ...
  <xsl:function name="gn-fn-iso19139.mgbcompleto:isNotMultilingualField" as="xs:boolean">
